      ...
      <div>
        ...
        <div className="filterDiv">
          <DropdownButton id="dropdown-basic-button" title="Year">
            <Dropdown.Item onClick={() => this.props.setYearRange(0, 2016)}>
              Older than 2016
            </Dropdown.Item>
            ...
            <Dropdown.Item
              onClick={() => this.props.setYearRange(2018, Infinity)}
            >
              Younger Than 2018{" "}
            </Dropdown.Item>
          ...
          <DropdownButton id="dropdown-basic-button" title="Price">
            <Dropdown.Item onClick={() => this.props.setPriceRange(0, 150000)}>
              Less than R150 000
            </Dropdown.Item>
            <Dropdown.Item onClick={() => this.props.setPriceRange(0, 200000)}>
              Less than R200 000
            </Dropdown.Item>
            <Dropdown.Item
              onClick={() => this.props.setPriceRange(200000, Infinity)}
            >
              More than R200 000
            </Dropdown.Item>
            <Dropdown.Item
